...
function lin_h3(x) { return t30.Value() + t31.Value() * x };
function clip_h3(x) { return activation(lin_h3(x)) };
function scale_h3(x) { return p3.Value() * clip_h3(x) };

function lin_output(x) {
        return p0.Value() + scale_h1(x) + scale_h2(x) + scale_h3(x)
};
